...
static char bar[] = "#1a1b26";
static char bar_text[] = "#a9b1d6";
static char bar_select[] = "#414868";
static char bar_black[] = "#252525";

static char *colors[][3] = {
               /*               fg              bg              border   */
    [SchemeNorm]        = { bar_black,          bar,            normbordercolor },
    [SchemeSel]         = { bar_black,          bar,            selbordercolor  },
    [SchemeStatus]      = { bar_text,           bar,            bar_black  }, // Right
    [SchemeTagsSel]     = { bar_text,           bar_select,     bar_black  }, // Left
    [SchemeTagsNorm]    = { bar_text,           bar,            bar_black  }, // Left
    [SchemeInfoSel]     = { bar_text,           bar,            bar_black  }, // Middle
    [SchemeInfoNorm]    = { bar_text,           bar,            bar_black  }, // Middle
};
/* FONTS */
static const char *fonts[] = {
  "Roboto:pixelsize=18",
  "JetBrainsMono Nerd Font Mono:pixelsize=24"
};
...
static const Rule rules[] = {
    ...
    { "Steam",          NULL,       NULL,       1 << 8,     False,      2 },
    { "librewolf",      NULL,       NULL,       1 << 1,     False,      2 },
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", bar, "-nf", bar_text, "-sb", bar, "-sf", bar_text, NULL };
static const char *termcmd[]  = { TERMINAL, NULL };
static const char *termcmd2[]  = { "alacritty", NULL };
static const char *school[] = { "chromium", NULL };
static const char *mysql[] = { "mysql-workbench", NULL };
...
static Key keys[] = {
    ...
    { MODKEY,                   XK_F2,      spawn,          SHCMD("batdunst --charge") },
